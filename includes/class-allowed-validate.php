...
/**
 * Controller for the `/allowed/v1/validate` route
 * in the REST API.
 */
class Allowed_Validate extends WP_REST_Controller {
	...
	/**
	 * Registers `POST /allowed/v1/validate` route.
	 *
	 * @return void
	 */
	...
	public function prepare_item_for_response( $user, $request ) {
		...
		return apply_filters( 'allowed_validate_prepare_user', $response, $user, $request );
	}
